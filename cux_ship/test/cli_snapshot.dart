...
String _compile() {
  ...
  // the same filesystem as the rename below and is cleaned by `dart pub`'s own
  // housekeeping rather than left in the system temp directory. It is 25MB;
  // one shared copy, not one per suite.
